...
//go:generate mockgen -source namesrv.go -destination mock_namesrv.go -self_package git.myscrm.cn/golang/rocketmq-client-go/v2/internal  --package internal Namesrvs

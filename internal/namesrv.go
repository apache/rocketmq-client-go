...
//go:generate mockgen -source namesrv.go -destination mock_namesrv.go -self_package github.com/MasterYang7/rocketmq-client-go/v2/internal  --package internal Namesrvs

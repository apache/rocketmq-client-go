...
func TestAllocateByAveragely(t *testing.T) {
	Convey("Given message queues with a starting value", t, func() {
		...
		Convey("the result of AllocateByAveragely should be deep expectedQueue", func() {
...
func TestAllocateByAveragelyCircle(t *testing.T) {
	Convey("Given message queues with a starting value", t, func() {
		...
		Convey("the result of AllocateByAveragelyCircle should be deep expectedQueue", func() {
			for _, value := range cases {

...
import (
	...
	"git.myscrm.cn/golang/rocketmq-client-go/v2/internal"
	"git.myscrm.cn/golang/rocketmq-client-go/v2/internal/remote"
	"git.myscrm.cn/golang/rocketmq-client-go/v2/internal/utils"
...
//go:generate mockgen -source offset_store.go -destination mock_offset_store.go -self_package git.myscrm.cn/golang/rocketmq-client-go/v2/consumer  --package consumer OffsetStore
